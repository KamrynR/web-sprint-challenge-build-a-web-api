...
1. The core features of Node.js and Express and why they are useful.
    Node allows JavaScript for server use. Express makes everything a lot cleaner.
1. Understand and explain the use of Middleware?
    Middleware allows CRUD functions to be changed/validated.
1. The basic principles of the REST architectural style.
    They give a global standard as to how an API should be structured.
1. Understand and explain the use of Express Routers.
    Allows for the route to be easily read.
1. Describe tooling used to manually test the correctness of an API.
    Applications like Insomnia allow for easy testing of an API.
